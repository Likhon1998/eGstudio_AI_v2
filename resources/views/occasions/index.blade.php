                                    ...
                                    <td class="px-4 sm:px-6 py-4 text-center align-top">
                                        <div x-show="dnaFailed() && !isRetryingPrompt" x-cloak class="flex flex-col items-center gap-2 max-w-[200px] mx-auto">
                                            ...
                                            <button type="button"
                                                ...
                                                :disabled="isRetryingPrompt"
                                                class="w-full px-3 py-2 bg-pink-600 hover:bg-pink-500 disabled:opacity-50 text-[8px] font-black text-white uppercase tracking-widest rounded-lg transition-all shadow-lg shadow-pink-600/20">
                                                Re-render DNA
                                            </button>
                                        </div>
                                        ...
                                        <template x-teleport="body">
                                            <div x-show="openModal" class="fixed inset-0 z-[999] flex items-center justify-center p-4 sm:p-6 bg-black/95 backdrop-blur-md" x-cloak>
                                                ...
                                                <div x-show="openModal === 'createPost'"
                                                     ...
                                                     class="relative bg-[#0f0f0f] border border-white/5 w-full max-w-3xl rounded-xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
                                                    ...
                                                    {{-- Language picker: full-modal layer (not clipped by scroll body) --}}
                                                    <template x-teleport="body">
