                        ...
                        @forelse($logos as $logo)
                            <div class="bg-black border border-white/5 rounded-xl overflow-hidden group hover:border-blue-500/30 transition-all shadow-xl relative flex flex-col">
                                ...
                                <div class="aspect-square w-full relative bg-[url('data:image/svg+xml;base64,')] border-b border-white/5 p-4 flex items-center justify-center">
                                    @if($logo->fileExistsOnDisk())
                                        <img src="{{ $logo->url }}" alt="{{ $logo->name }}" loading="lazy"
                                            class="max-w-full max-h-full object-contain drop-shadow-2xl transition-transform group-hover:scale-110 duration-500"
                                            onerror="this.classList.add('hidden'); this.nextElementSibling?.classList.remove('hidden');">
                                        <div class="hidden flex flex-col items-center justify-center gap-2 p-2 text-center">
                                            <span class="text-[8px] font-black text-amber-400 uppercase tracking-widest">File Missing</span>
                                        </div>
                                    @else
                                        <div class="flex flex-col items-center justify-center gap-2 p-2 text-center">
                                            <svg class="w-8 h-8 text-amber-500/70" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                            <span class="text-[8px] font-black text-amber-400 uppercase tracking-widest">Re-upload</span>
                                        </div>
                                    @endif
