                    ...
                    @foreach($images as $image)
                        ...
                        <div x-show="filter === 'all' || filter === 'raw'" 
                            ...
                            <div class="relative aspect-square bg-black cursor-pointer overflow-hidden" 
                                 @click="openModal = true; currentImage = '{{ $image->image_url }}'; $dispatch('notify', {message: 'Enlarging Raw Still', type: 'info'})">
                                <img src="{{ $image->image_url }}" class="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-all duration-500">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center pt-4 border-t border-white/5 mt-4">
                                    ...
                                    <a href="{{ $image->image_url }}" download @click.stop class="text-gray-600 hover:text-white"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg></a>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div x-show="filter === 'all' || filter === 'branded'" 
                            ...
                            <div class="relative aspect-square bg-black cursor-pointer overflow-hidden" 
                                 @click="openModal = true; currentImage = '{{ $image->branded_image_url }}'; $dispatch('notify', {message: 'Enlarging Branded Still', type: 'info'})">
                                <img src="{{ $image->branded_image_url }}" class="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-all duration-500">
                                <div class="absolute top-4 left-4">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center pt-4 border-t border-white/5 mt-4">
                                    ...
                                    <a href="{{ $image->branded_image_url }}" download @click.stop class="text-gray-600 hover:text-white"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg></a>
                                </div>
                            </div>
                        </div>
                        @endif
